...
<cms:template title="other-overview">
...
<html>
	<head> 
	  ...
	  <title>Mitchell Wolfe - Other Overview</title>
	  <meta name="description" content="Mitchell Wolfe's Website, Other Section">
	...
	<body>
		<nav>
			...
			<ul class="nav-bar">
				...
				<li><a class="current-strike" href="/pages/other-overview/">Other</a></li>
