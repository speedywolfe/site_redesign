...
<cms:template title="About">
	<cms:editable name="about_me_text" type="textarea" />
	<cms:editable name="portrait" type="image" />
</cms:template>
<!doctype html>
<html>
	<head> 
	  ...
	  <title>Mitchell Wolfe - About <cms:show project_name /></title>
	  <meta name="description" content="Mitchell Wolfe's Website, About Section">
	...
	<body>
		<nav>
			...
			<ul class="nav-bar">
				...
				<li><a class="current-strike" href="/pages/about/">About</a></li>
			</ul>
		</nav>
		<section class="overview-holder">
				<span> About Me </span>
				<p class="proj_description_text"> <cms:show about_me_text /> </p>
				<img src="<cms:show portrait />">
		</section>
		<footer>
			<ul id="links">
